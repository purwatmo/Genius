...
#define VERSION_NUM "2.37F"
#define VERSION_DATE "24/02/2011"
...
enum eTestMMC{tmDisplayDetectMMC,tmScanMMCExist,tmDisplayPresent,tmDelayDisplayPresent,tmDisplayInit,
              tmInitialize,tmWaitInstruction,tmReadSector,tmDisplayData,tmFillData,tmWriteSector,tmResetCard};
