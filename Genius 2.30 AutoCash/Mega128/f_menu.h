...
enum stateLoyaltyMenu{mlInit,mlLoyaltySelect,mlUpdateLoyalty,mlSelectFIP,mlShowEnquiry,mlInputRFID,
					  ...
					  mlDispEnquiry,mlNoConnection,mlDelayExitLoyalty,mlExitLoyalty};
...
enum TResultUI{USER_NONE,USER_CANCEL,USER_INPUT,USER_OK,USER_ENTRY,USER_NO_DATA};
...
enum eSettingHeader{shInitHeader,shHeaderSelect,shEditHeader1,shEditHeader2,shSaveHeaderQuestions,shSaveHeader,shExitSettingHeader};
...
void	_menu_text(unsigned char);
void	_menu_setpassword(unsigned char);
