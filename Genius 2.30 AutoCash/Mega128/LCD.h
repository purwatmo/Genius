...
#define _LCD_CLR	lcd_command(1 << 0) 
#define _LCD_HOME	lcd_command(1 << 1)
#define _LCD_LEFT	lcd_command(0x10)
#define _LCD_RIGHT	lcd_command(0x14)
...
void lcd_clear();
void lcd_put(unsigned char, unsigned char, unsigned char);
void lcd_cgram(unsigned char, char*);
