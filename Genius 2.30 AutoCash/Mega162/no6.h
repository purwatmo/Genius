...
enum PoolingPumpState{ppInit,ppNextPump,ppGetStatus,ppWaitIdle,ppSendStatusRequest,
                  ...
                  // 0        
enum eWaynePooling{pwInit,pwInitPumpAddr,pwScanStatus,pwWaitScanReply,pwNoPump,pwUpdatePumpStatus,pwSendPumpStatus,pwNextAction,
                   pwSendGeneralStatus,
				   pwSendTotalizerRequest,pwWaitTotalizerACK,pwRetrySendTotalizerRequest,pwSendTotalizerInfo,pwWaitTotalizerInfoACK,
				   pwSendTransactionRequest,pwWaitTransACK,pwRetrySendTransRequest,pwSendTransMessage,
				   pwSendAuthorizeCommand,pwWaitAuthACK,pwRetrySendAuthorizeCommand,pwSendPriceConfig,pwWaitACK,pwReplyACK,pwScanMessage,pwInitDelayNextPump,
				   pwDelayNextPump,pwNextPump};
				   
enum eWayneReply{WR_NONE,WR_READY,WR_ACK,WR_NACK,WR_MESSAGE};
