...
//Msg09
//char strFreeMessageLine1[22],AdvanZ.Message09.strFreeMessageLine2[22],AdvanZ.Message09.strFreeMessageLine3[22],AdvanZ.Message09.strFreeMessageLine4[22];
...
static unsigned int nFlow=0;
	 ...
	 if ((data==0x03)||(nFlow>=MSG03_LENGTH)){
		 ...
		 if (EDCMsgCode==0x03){
             ...
             StrPosCopy(rcv_trans,AdvanZ.Message03.strCardType,11,15);
...
void sendMessage92(){
	...
	sprintf_P(strSend,PSTR("%s%s%s%s"),strTranNo,strFIP_ID,AdvanZ.Message03.strCardType,strCardID);
    _uart_print(1, 0,strSend);
    //_uart_print(0, 0,strSend);
