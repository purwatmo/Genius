...
void	uart_baudrate(unsigned char, unsigned long);
void	uart_print(unsigned char, unsigned char, char*);
void	uart_printf(unsigned char, unsigned char, char*);

unsigned char	uart(unsigned char, unsigned char, unsigned char);
